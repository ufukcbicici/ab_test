...
class RecommenderSplitGroups(Recommender):
    ...
    def get_target_variable_scaler(self, y, target_column, group_type):
        ...
        scaler_type = self.targetScaling[(target_column, group_type)]
    ...
    def train_regressors(self):
        ...
        for target_column in self.dataset.targetColumns:
            ...
            for group_type in group_types:
                ...
                target_scaler = self.get_target_variable_scaler(y=y_train,
